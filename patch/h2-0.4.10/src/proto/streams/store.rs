...
pub(super) trait Resolve {
    fn resolve(&'_ mut self, key: Key) -> Ptr<'_>;
}
...
impl Store {
    ...
    pub fn find_mut(&'_ mut self, id: &StreamId) -> Option<Ptr<'_>> {
    ...
    pub fn insert(&'_ mut self, id: StreamId, val: Stream) -> Ptr<'_> {
    ...
    pub fn find_entry(&'_ mut self, id: StreamId) -> Entry<'_> {
